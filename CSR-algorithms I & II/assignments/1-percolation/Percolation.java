...
public class Percolation {
    ...
    public Percolation(int n) {
        ...
        // the array that stores the open status of sites
        isOpen = new boolean[n][n];  
        this.n = n;
        // initialize a QuickUnionUF with an opening node and an ending node
        site = new WeightedQuickUnionUF(n*n+2);  
        // initialize a QuickUnionUF only with an opening node to assist isFull()
        siteWithoutEnding = new WeightedQuickUnionUF(n*n+1);  
